...
<%@ page import="com.organick.servlet.PCGrowthVisualService"%>
...
<%
    ...
    if(request.getMethod().indexOf("POST")>-1){
        ...
        ScriptBuilder scriptBuilder = PCGrowthVisualService.getVisual(nations, starting, ending, reportString);
...
<html>
    ...
    <body>
        <h1><a href="index.jsp">Again! Again!</a></h1>
        <h2><%=gameString%></h2>
...
<html>
    ...
    <body>
        <div id="content">
            ...
            <form method="POST" action="/mepbm/pcGrowth/">
                ...
                <div id="report" style="display: none;">
                    <h3>Which <span style="font-weight: bold;">Measurement</span> would you like a report on?</h3>
                    <select name="report" onchange="processReport();">
                        <option value="-1">-- SELECT --</option>
                        <option value="count">Population Center Count</option>
                    </select>
                    <div>
                        <%
                        for(String gameA : gameList){
            ...
            <br /><br /><br />
            <a href="/mepbm/pcGrowth/errors.jsp" style="color: red; font-size: 8px;">known errors</a>
        </div>
    </body>
</html>
<%
