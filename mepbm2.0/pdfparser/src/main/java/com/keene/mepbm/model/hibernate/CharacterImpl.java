...
public class CharacterImpl implements Serializable, Character<GameImpl, TurnNumberImpl, HexImpl, NationImpl, NationTurnImpl, ArmyImpl, PopulationCenterImpl, CharacterImpl>, HibernateModel {
    ...
    @Override
    public NationImpl getDoubleAgentOf() {
        return doubleAgentOf;
    }

    @Override
    public void setDoubleAgentOf(NationImpl doubleAgentOf) {
        this.doubleAgentOf = doubleAgentOf;
    }

    @Override
    public NationImpl getHostageOf() {
        return hostageOf;
    }

    @Override
    public void setHostageOf(NationImpl hostageOf) {
    ...
    @Override
    public ArmyImpl getInArmy() {
        return inArmy;
    }

    @Override
    public void setInArmy(ArmyImpl inArmy) {
        this.inArmy = inArmy;
    }
    ...
    @Override
    public CharacterImpl getHeldBy() {
        return heldBy;
    }

    @Override
    public void setHeldBy(CharacterImpl heldBy) {
        this.heldBy = heldBy;
    }
