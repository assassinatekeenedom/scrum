...
public final class Miscellaneous extends TurnPDFSection {
    ...
    private void parseMaintenance() {
        ...
        this.getData().getPersistence().getUpkeepDAO().save(upkeep);
        ResourceDetails resources = new ResourceDetailsImpl();
        this.getData().getPersistence().getResourceDetailsDAO().save(resources);
    ...
    private Artifact parseArtifactDetails() {
        ...
        Artifact artifact = this.getData().getPersistence().getArtifactDAO().load(number, this.getData().getActiveGame(), this.getData().getActiveNationTurn().getTurnNumber());
