...
public enum Bat implements Virtual {
    ...
    SELENIUM_CHROME_C(new IO("C:/selenium/golden/target/bin", "chromeC", "bat", "@echo off\nstart java -jar C:\\bin\\selenium\\lib\\selenium.jar -role node -port 5561 -hub http://localhost:4444/grid/register-browser -browser \"browserName=chrome,chrome_binary=C:\\Program Files (x86)\\Google\\Chrome\\Application\\chrome.exe ,maxInstances=5, platform=WINDOWS\"\nexit")),
    SELENIUM_CHROME_D(new IO("C:/selenium/golden/target/bin", "chromeD", "bat", "@echo off\nstart java -jar C:\\bin\\selenium\\lib\\selenium.jar -role node -port 5562 -hub http://localhost:4444/grid/register-browser -browser \"browserName=chrome,chrome_binary=C:\\Program Files (x86)\\Google\\Chrome\\Application\\chrome.exe ,maxInstances=5, platform=WINDOWS\"\nexit")),
    SELENIUM_CHROME_E(new IO("C:/selenium/golden/target/bin", "chromeE", "bat", "@echo off\nstart java -jar C:\\bin\\selenium\\lib\\selenium.jar -role node -port 5563 -hub http://localhost:4444/grid/register-browser -browser \"browserName=chrome,chrome_binary=C:\\Program Files (x86)\\Google\\Chrome\\Application\\chrome.exe ,maxInstances=5, platform=WINDOWS\"\nexit")),
    SELENIUM_CHROME_F(new IO("C:/selenium/golden/target/bin", "chromeF", "bat", "@echo off\nstart java -jar C:\\bin\\selenium\\lib\\selenium.jar -role node -port 5564 -hub http://localhost:4444/grid/register-browser -browser \"browserName=chrome,chrome_binary=C:\\Program Files (x86)\\Google\\Chrome\\Application\\chrome.exe ,maxInstances=5, platform=WINDOWS\"\nexit")),
