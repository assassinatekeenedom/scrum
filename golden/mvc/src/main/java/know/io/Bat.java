...
public enum Bat implements Virtual {
    ...
    FITNESSE(new IO("C:/selenium/golden/target/bin", "fitnesse", "bat", "@echo off\nif exist C:\\selenium\\bin\\fitnesse\\FitNesseRoot rmdir /s /q C:\\selenium\\bin\\fitnesse\\FitNesseRoot\nstart java -jar C:\\selenium\\bin\\fitnesse\\fitnesse-standalone.jar -p 121 -d C:\\selenium\\bin\\fitnesse\nexit")), DB_LOGIN(new IO("C:/selenium/golden/target/bin", "dblogin", "bat", "@ECHO OFF\nstart C:\\selenium\\bin\\mysql\\bin\\mysql.exe -u root")),
    DB_ADMIN(new IO("C:/selenium/golden/target/bin", "dbadmin", "bat", "@ECHO OFF\nC:\\selenium\\bin\\mysql\\bin\\mysql.exe -u root --execute=%1% | echo %%i% > C:\\selenium\\golden\\target\\log\\allDatabases.log\nexit")),
    DB_CREATE(new IO("C:/selenium/golden/target/bin", "create", "bat", "@ECHO OFF\nC:\\selenium\\bin\\mysql\\bin\\mysql.exe -u root --execute=\"create database %1%\"\nexit")),
    DB_SAVE(new IO("C:/selenium/golden/target/bin", "dbsave", "bat", "@ECHO OFF\nC:\\selenium\\bin\\mysql\\bin\\mysqldump.exe --databases selenium -u root > C:\\selenium\\golden\\target\\log\\selenium.sql\nexit")),
    ...
    DB_COMMAND(new IO("C:/selenium/golden/target/bin", "dbcommand", "bat", "@ECHO OFF\nC:\\selenium\\bin\\mysql\\bin\\mysql.exe selenium -u root --execute=%1% | echo %%i% > C:\\selenium\\golden\\target\\log\\%2%\nexit")),
    DB_GOLDEN(new IO("C:/selenium/golden/target/bin", "dbgolden", "bat", "@ECHO OFF\nstart dbadmin.bat \"show databases\"")),
    DB_CLEAN(new IO("C:/selenium/golden/target/bin", "dbclean", "bat", "@ECHO OFF\nC:\\selenium\\bin\\mysql\\bin\\mysql.exe -u root --execute=\"drop database selenium\"\nC:\\selenium\\bin\\mysql\\bin\\mysql.exe -u root --execute=\"create database selenium\"")),
    DB_DROP(new IO("C:/selenium/golden/target/bin", "drop", "bat", "@ECHO OFF\nC:\\selenium\\bin\\mysql\\bin\\mysql.exe -u root --execute=\"drop database %1%\"\nexit")),
    ...
    SELENIUM_HUB(new IO("C:/selenium/golden/target/bin", "hub", "bat", "@echo off\nstart java -jar C:\\selenium\\bin\\selenium\\lib\\selenium.jar -role hub\nexit")),
    SELENIUM_CHROME_A(new IO("C:/selenium/golden/target/bin", "chromeA", "bat", "@echo off\nstart java -jar C:\\selenium\\bin\\selenium\\lib\\selenium.jar -role node -port 5559 -hub http://localhost:4444/grid/register-browser -browser \"browserName=chrome,chrome_binary=C:\\Program Files (x86)\\Google\\Chrome\\Application\\chrome.exe ,maxInstances=5, platform=WINDOWS\"\nexit")),
    SELENIUM_CHROME_B(new IO("C:/selenium/golden/target/bin", "chromeB", "bat", "@echo off\nstart java -jar C:\\selenium\\bin\\selenium\\lib\\selenium.jar -role node -port 5560 -hub http://localhost:4444/grid/register-browser -browser \"browserName=chrome,chrome_binary=C:\\Program Files (x86)\\Google\\Chrome\\Application\\chrome.exe ,maxInstances=5, platform=WINDOWS\"\nexit")),
    ...
    SERVICES_START(new IO("C:/selenium/golden/target/bin", "services", "bat", "@echo off\nstart C:\\selenium\\bin\\apache\\bin\\Apache.exe && start C:\\selenium\\bin\\mysql\\bin\\mysqld.exe\nexit"));
